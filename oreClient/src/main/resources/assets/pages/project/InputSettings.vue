<template>
    ...
    <div class="setting">
        ...
        <input @if(keywords.nonEmpty) { value="@keywords.mkString(" ")" } form="@form" type="text" class="form-control"
        id="keywords"
    ...
    <div class="setting">
        <div class="setting-description">
            ...
            <p>
                Having a custom homepage for your project helps you look more proper, official, and gives you another
                place
                to gather information about your project.
            </p>
        </div>
        <input @if(homepage.isDefined) { value="@homepage.get" } form="@form" type="url" class="form-control"
               id="homepage"
    ...
    <div class="setting">
        ...
        <div class="setting-content">
            <label>
                <input @if(forumSync) { checked } value="true" form="@form" type="checkbox" id="forum-sync"
                       name="forum-sync">
                Make forum posts
            </label>
        </div>
