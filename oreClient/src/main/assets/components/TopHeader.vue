    ...
    <nav id="topbar" class="navbar-main navbar-inverse">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-collapse collapse navbar-right">
                ...
                <li class="nav-icon authors-icon" data-toggle="tooltip" data-placement="bottom"
                ...
                <li v-if="permissions.includes('is_staff')" class="nav-icon staff-icon" data-toggle="tooltip"
                    data-placement="bottom" title="View Sponge staff.">
                ...
                <li v-if="currentUser" class="dropdown user-controls nav-icon">
                    <a href="#" class="drop-down-toggle user-toggle" data-toggle="dropdown">
                        <span v-if="headerData && headerData.hasNotice" class="unread"></span>
                        <img height="32" width="32" class="user-avatar" :src="avatarUrl(currentUser.name)"
                    ...
                    <ul class="user-dropdown dropdown-menu" aria-label="dropdownMenu1">
                        ...
                        <li v-if="currentUser">
                            <a :href="routes.Users.showNotifications(null, null).absoluteURL()">
                                ...
                                <span>
                                Notifications
                                <span v-if="headerData && headerData.hasUnreadNotifications" class="unread"></span>
                                </span>
                            </a>
                        </li>
                        ...
                        <li v-if="permissions.includes('mod_notes_and_flags')">
                            <a :href="routes.Application.showFlags().absoluteURL()">
                                ...
                                <span>
                                Flags
                                <span v-if="headerData && headerData.unresolvedFlags" class="unread"></span>
                                </span>
                            </a>
                        </li>
                        ...
                        <li v-if="permissions.includes('mod_notes_and_flags')">
                            <a :href="routes.Application.showProjectVisibility().absoluteURL()">
                                ...
                                <span>
                                Project approvals
                                <span v-if="headerData && headerData.hasProjectApprovals" class="unread"></span>
                                </span>
                            </a>
                        </li>
                        ...
                        <li v-if="permissions.includes('reviewer')">
                            <a :href="routes.Application.showQueue().absoluteURL()">
                                ...
                                <span>
                                Version approvals
                                <span v-if="headerData && headerData.hasReviewQueue" class="unread"></span>
                        </span>
                            </a>
                        </li>
                ...
                <li v-if="!currentUser">
                    <div class="btn-group-login">
                        <a :href="routes.Users.signUp().absoluteURL()"
                           class="btn btn-primary navbar-btn">Sign up</a>
                        <a :href="routes.Users.logIn(null, null, currentPath).absoluteURL()"
